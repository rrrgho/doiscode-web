                            ...
                            <div className="row">
                                <div className="col-lg-8 order-2 order-lg-1 mt_md--40 mt_sm--40">
                                    <div className="inner text-start">
                                        <h1 className="title theme-gradient display-three">Having questions? {" "} <br/>
                                            <Typed
                                                strings={[
                                                    "Contact Us.",
                                                    "Discuss.",
                                        ...
                                        <div className="button-group">
                                            <a className="btn-default bounce btn-medium round btn-icon" target="_blank" href="https://wa.me/+6285186897566/?text=Hi,%20I%20Want%20to%20Consult%20with%20WighoDigital%20Support%20Team">Whatsapp <i className="icon"><FaWhatsapp /></i></a>
